...
namespace Entity
{
	...
	*/
	...
	public:
		...
		void ToggleVisibility(bool b) { isVisible = b; }
	...
	private:
		...
		std::vector<TexturePtr> blendTexture;///		ブレンドマップ用のテクスチャ使用時に使う.
	...
	*/
	...
	public:
		...
		Entity* AddEntity(int groupId, const glm::vec3& pos, const Mesh::MeshPtr& m, const TexturePtr& t,
			const Shader::ProgramPtr& p, Entity::UpdateFuncType func, bool isInitialWrite = false);
